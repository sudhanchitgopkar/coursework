...
\maketitle
\tableofcontents \clearpage\section{01.26.21}
\label{sec:org2d75934}
\subsection{Closure Introduction}
\label{sec:org4b60e7b}
\begin{itemize}
...
\label{sec:org971b34a}
\begin{itemize}
\item M\textsubscript{1} = \{Q\textsubscript{1},\(\Sigma\),\(\delta\)\textsubscript{1},q\textsubscript{0\textsubscript{1}},F\textsubscript{1}\} and M\textsubscript{2} are DFAs
...
\end{itemize}
\section{01.21.21}
\label{sec:orgd45dfae}
\subsection{Deterministic Finite Automata}
\label{sec:orgb14f225}
\begin{itemize}
...
\label{sec:org5eb1c69}
\section{01.19.21}
\label{sec:org20d90fe}
\subsection{Tuples \& DFAs}
\label{sec:org30e611d}
\begin{itemize}
...
\end{itemize}
\section{01.14.21}
\label{sec:org5c48ec2}
\subsection{Automaton (automata)}
\label{sec:org5369f78}
\begin{itemize}
...
\label{sec:org8856566}
\subsubsection{Mathematicians \& History}
\label{sec:orgd4b6d86}
\begin{itemize}

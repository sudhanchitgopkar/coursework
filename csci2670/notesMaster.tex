...
\label{sec:orgd9069af}
\subsection{Deterministic Finite Automata}
\label{sec:orgdfa844f}
\begin{itemize}
...
\label{sec:orgc60ba48}
\section{01.19.21}
\label{sec:org253d2fa}
...
\end{itemize}
\section{01.14.21}
\label{sec:orgf767231}
\subsection{Automaton (automata)}
\label{sec:orgfd64045}
\begin{itemize}
...
\label{sec:org17dfb27}
\subsubsection{Mathematicians \& History}
\label{sec:orgc7c7aaf}
\begin{itemize}
